...
class DetallesActuales extends StatefulWidget {
  const DetallesActuales({Key? key}) : super(key: key);

  @override
  State<DetallesActuales> createState() => _DetallesActualesState();
}

class _DetallesActualesState extends State<DetallesActuales> {
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        decoration: const BoxDecoration(
          ...
          colors: [
            Color.fromARGB(255, 221, 95, 28),
            Color.fromARGB(160, 67, 52, 11),
            Color.fromRGBO(165, 73, 40, 1)
          ],
        )),
        child: SafeArea(
          child: Column(
...
class EndActualDetails extends StatelessWidget {
  const EndActualDetails({
    super.key,
...
class MidActualDetails extends StatelessWidget {
  const MidActualDetails({
    super.key,
    this.temperatura,
    this.nubes,
  });
...
class InfoActualMid extends StatelessWidget {
  const InfoActualMid({
    super.key,
    required this.nubes,
...
class TopActualDetails extends StatelessWidget {
  const TopActualDetails({super.key});
